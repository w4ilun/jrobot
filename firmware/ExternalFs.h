...
private:
    ...
    inline static const long SIZE()
    {
        return MOTION_FILE_SIZE;
    }

public:
    //! @brief Chunk size of external EEPROM (bytes)
    inline static const int CHUNK_SIZE()
    {
        return 32;
    }

    //! @brief Slot size of external EEPROM (bytes)
    inline static const int SLOT_SIZE()
    {
        return 30;
    }

    //! @brief Beginning value of slots
    inline static const int SLOT_BEGIN()
    {
        return 0;
    }

    //! @brief End value of slots
    inline static const int SLOT_END()
    {
